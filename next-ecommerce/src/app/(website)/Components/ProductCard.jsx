        ...
        <>
            <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                <div class="h-56 w-full">
                    <a href="#">
                        <img class="mx-auto h-full dark:hidden" src={productData.image} alt="" />
                        <img class="mx-auto hidden h-full dark:block" src={productData.image} alt="" />
                    </a>
                </div>
                <div class="pt-6">
                    <div class="mb-4 flex items-center justify-between gap-4">
                        <span class="me-2 rounded bg-primary-100 px-2.5 py-0.5 text-xs font-medium text-primary-800 dark:bg-primary-900 dark:text-primary-300"> Up to {productData.discount_percentage}% off </span>
                        ...
                        <div class="flex items-center justify-end gap-1">
                            ...
                            <button type="button" onClick={ () => dispatch(addToCart(productData) ) } data-tooltip-target="tooltip-add-to-favorites" class="rounded-lg p-2 text-gray-500 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                    ...
                    <a href="#" class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">{productData.name}</a>
                    ...
                    <div class="mt-2 flex items-center gap-2">
                        ...
                        <p class="text-sm font-medium text-gray-900 dark:text-white">{productData.rating}</p>
                    ...
                    <div class="mt-4 flex items-center justify-between gap-4">
                        <p class="text-2xl font-extrabold leading-tight text-gray-900 dark:text-white">${productData.price}</p>
