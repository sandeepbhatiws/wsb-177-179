...
exports.viewSubCategories = async(request, response) => {
    ...
    await subCategoryModel.find(condition).select('name parent_category_id')
    .sort({
        _id : 'desc'
    })
    .then((result) => {
...
exports.create = async(request, response) => {
    ...
    await subSubCategoryModel(dataSave)
    .save()
    .then((result) => {
        const data = {
            _status : true,
...
exports.view = async(request, response) => {
    ...
    await subSubCategoryModel.find(filter).select('name parent_category_id sub_category_id image slug order status').limit(limit).skip(skip)
